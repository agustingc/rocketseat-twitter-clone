...
export const Container = styled.div`
  ...
  max-width: 100%; /* 100% of screen size */
`;
...
export const Header = styled.div`
  ...
  span {
    ...
    white-space: nowrap; /* Text will never wrap to the next line (creates overflow). */
...
export const Icons = styled.div`
  ...
  flex-wrap: wrap;
  margin: 11px auto 0; /* top right&left bottom ; auto centers element horizontally */
  width: 100%; /** Mobile */
